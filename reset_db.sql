...
INSERT INTO homepage_board(description, hashtag, image, user_id, board_list_id) VALUES ('Landscape #10','#landscapes','https://picsum.photos/id/10/200/300', 1, 1);
...
INSERT INTO boardgame_board(description, hashtag, image, user_id, board_list_id) VALUES ('Brass: Birmingham','#boardgame', 'https://cf.geekdo-images.com/x3zxjr-Vw5iU4yDPg70Jgw__imagepage/img/-17KkOmxbTu2slJTabGrkO8ZW8s=/fit-in/900x600/filters:no_upscale():strip_icc()/pic3490053.jpg', 1, 2);
INSERT INTO boardgame_board(description, hashtag, image, user_id, board_list_id) VALUES ('Camel Up',         '#boardgame', 'https://cf.geekdo-images.com/pRZrHJNoPQ3gay9EkpuZLw__imagepage/img/irfKJQj_CqQHYn9QJ89tVLzMX-A=/fit-in/900x600/filters:no_upscale():strip_icc()/pic4304741.jpg', 1, 2);
...
INSERT INTO macbook_board(description, hashtag, image, user_id, board_list_id) VALUES ('Macbook #10', '#technology','https://picsum.photos/id/0/300/300', 3, 1);
...
INSERT INTO cityscape_board(description, hashtag, image, user_id, board_list_id) VALUES ('City #10','#city', 'https://picsum.photos/id/232/300/500', 3, 1);
